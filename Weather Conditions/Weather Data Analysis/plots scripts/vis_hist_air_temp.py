...
def airTemp_histogram(csv_file_path):
    """
    ...
    celsius_symbol = u'\u00b0C'
    plt.title(f'Histogram of Corr. Coeff. Between Air Temperature ({celsius_symbol}) and Points Earned by Drivers')
    plt.show()

csv_file_path = 'cleaned_f1_merged_data.csv'

# Call the function with the cleaned CSV file path
airTemp_histogram(csv_file_path)
