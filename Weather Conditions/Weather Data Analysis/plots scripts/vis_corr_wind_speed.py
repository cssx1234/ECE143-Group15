...
def windspeed_correlation(csv_file_path):
    """
    ...
    plt.title('Corr. Coeff. Between Wind Speed (knots) and Points Earned by Each Driver')
    plt.show()

csv_file_path = 'cleaned_f1_merged_data.csv'

# Call the function with the cleaned CSV file path
windspeed_correlation(csv_file_path)
